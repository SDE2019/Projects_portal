...
namespace ProjectProgressMonitoringSystem.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TeacherName,TeacherID,Password")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TeacherName,TeacherID,Password")] Teacher teacher)
        {
            if (ModelState.IsValid)
            {
